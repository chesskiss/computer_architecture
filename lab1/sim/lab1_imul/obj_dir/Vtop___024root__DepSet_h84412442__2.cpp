...
VlCoroutine Vtop___024root___eval_initial__TOP__1__2(Vtop___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop___024root___eval_initial__TOP__1__2\n"); );
    // Init
    ...
    // Body
    while (VL_GTS_III(32, 0x1f4U, vlSelf->top__DOT__unnamedblk14__DOT__x)) {
        __Vtask_top__DOT__test_task__75__b = VL_RANDOM_I();
        __Vtask_top__DOT__test_task__75__a = VL_RANDOM_I();
        ...
        if (vlSymsp->_vm_contextp__->assertOn()) {
            if (VL_LIKELY(((__Vtask_top__DOT__test_task__75__a 
                ...
                VL_WRITEF("[%0t] %%Error: tb_IntMul.v:481: Assertion failed in %Ntop.test_task: Failed: in0 = %10#, in1 = %10#, out = %10#\n",
                          ...
                          vlSymsp->name(),32,__Vtask_top__DOT__test_task__75__a,
                          32,__Vtask_top__DOT__test_task__75__b,
                          32,vlSelf->top__DOT__ostream_msg);
        ...
        vlSelf->top__DOT__unnamedblk14__DOT__x = ((IData)(1U) 
                                                  + vlSelf->top__DOT__unnamedblk14__DOT__x);
    }
    co_await vlSelf->__VtrigSched_h3cadd47d__0.trigger(0U, 
                                                       nullptr, 
                                                       "@(negedge clk)", 

...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[4U])) {
        bufp->chgBit(oldp+273,(vlSelf->top__DOT__istream_rdy));
        bufp->chgBit(oldp+274,(vlSelf->top__DOT__ostream_val));
        bufp->chgIData(oldp+275,(vlSelf->top__DOT__ostream_msg),32);
        bufp->chgIData(oldp+276,(vlSelf->top__DOT__imul__DOT__vc_trace__DOT__cycles),32);
    }
    bufp->chgBit(oldp+277,(vlSelf->clk));
    bufp->chgBit(oldp+278,(vlSelf->linetrace));
    bufp->chgQData(oldp+279,(vlSelf->top__DOT__istream_msg),64);
    bufp->chgIData(oldp+281,((IData)((vlSelf->top__DOT__istream_msg 
                                      >> 0x20U))),32);
    bufp->chgIData(oldp+282,((IData)(vlSelf->top__DOT__istream_msg)),32);
    bufp->chgBit(oldp+283,(vlSelf->top__DOT__imul__DOT__next_ostream_val));
    bufp->chgIData(oldp+284,(vlSelf->top__DOT__imul__DOT__next_ostream_msg),32);
    bufp->chgCData(oldp+285,(vlSelf->top__DOT__imul__DOT__vc_trace__DOT__level),4);
}

...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    for (int __Vi0 = 0; __Vi0 < 35; ++__Vi0) {
        vlSelf->top__DOT__num[__Vi0] = VL_RAND_RESET_I(32);
    }
    ...
    vlSelf->top__DOT__unnamedblk7__DOT__x = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__unnamedblk8__DOT__x = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__unnamedblk9__DOT__x = VL_RAND_RESET_I(32);
    ...
    vlSelf->__Vtask_top__DOT__test_task__54__a = VL_RAND_RESET_I(32);
    vlSelf->__Vtask_top__DOT__test_task__54__b = VL_RAND_RESET_I(32);

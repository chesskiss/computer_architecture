//      // verilator_coverage annotation
        ...
        (
 568284   input logic         clk,
 000552   input logic         reset,
 064434   input logic         val,
 100036   input logic         rdy,
%000000   input mem_req_4B_t  msg
        );
        
%000000   logic [2:0]   type_;
          assign type_  = msg.type_;
%000000   logic [7:0]   opaque;
          assign opaque = msg.opaque;
 000692   logic [31:0]  addr;
          assign addr   = msg.addr;
%000000   logic [1:0]   len;
          assign len    = msg.len;
 000092   logic [31:0]  data;
...
%000000   logic [8*2-1:0] type_str;
 ...
 568284   input logic          clk,
 000552   input logic          reset,
 063519   input logic          val,
 069267   input logic          rdy,
...
%000000   logic [7:0]   opaque;
          assign opaque = msg.opaque;
%000000   logic [1:0]   test;
          assign test   = msg.test;
%000000   logic [1:0]   len;
          assign len    = msg.len;
 001844   logic [31:0]  data;
          assign data   = msg.data;

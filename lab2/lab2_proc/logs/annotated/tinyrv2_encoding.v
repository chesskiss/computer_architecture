...
%000000       default            : disasm_tiny = "????";
 ...
 000022   input  [`TINYRV2_INST_NBITS-1:0]        inst,
        
          // Packed fields
        
 000022   output [`TINYRV2_INST_OPCODE_NBITS-1:0] opcode,
 000158   output [`TINYRV2_INST_RD_NBITS-1:0]     rd,
 000048   output [`TINYRV2_INST_RS1_NBITS-1:0]    rs1,
 000458   output [`TINYRV2_INST_RS2_NBITS-1:0]    rs2,
 000322   output [`TINYRV2_INST_FUNCT3_NBITS-1:0] funct3,
%000000   output [`TINYRV2_INST_FUNCT7_NBITS-1:0] funct7,
 000458   output [`TINYRV2_INST_CSR_NBITS-1:0]    csr
        );

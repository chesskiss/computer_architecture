...
class alignas(VL_CACHE_LINE_BYTES) Vtop___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*1:0*/ top__DOT__src__DOT__index_next;
        CData/*1:0*/ top__DOT__src__DOT__index;
        CData/*0:0*/ top__DOT__src__DOT__reset_reg;
        CData/*0:0*/ top__DOT__src__DOT__done_next;
        CData/*0:0*/ top__DOT__src__DOT____Vtogcov__index_en;
        CData/*1:0*/ top__DOT__src__DOT____Vtogcov__index_next;
        CData/*1:0*/ top__DOT__src__DOT____Vtogcov__index;
        CData/*0:0*/ top__DOT__src__DOT____Vtogcov__reset_reg;
        CData/*0:0*/ top__DOT__src__DOT____Vtogcov__done_next;
        ...
        CData/*0:0*/ top__DOT__sink__DOT__index_en;
        CData/*1:0*/ top__DOT__sink__DOT__index_next;
        CData/*1:0*/ top__DOT__sink__DOT__index;
        CData/*0:0*/ top__DOT__sink__DOT__reset_reg;
        CData/*0:0*/ top__DOT__sink__DOT__done_next;
        CData/*0:0*/ top__DOT__sink__DOT__failed;
        CData/*3:0*/ top__DOT__sink__DOT__verbose;
        CData/*0:0*/ top__DOT__sink__DOT____Vtogcov__index_en;
        CData/*1:0*/ top__DOT__sink__DOT____Vtogcov__index_next;
        CData/*1:0*/ top__DOT__sink__DOT____Vtogcov__index;
        CData/*0:0*/ top__DOT__sink__DOT____Vtogcov__reset_reg;
        CData/*0:0*/ top__DOT__sink__DOT____Vtogcov__done_next;
        CData/*0:0*/ top__DOT__sink__DOT____Vtogcov__failed;
        CData/*3:0*/ top__DOT__sink__DOT____Vtogcov__verbose;
    ...
    struct {
        ...
        IData/*31:0*/ top__DOT__sink__DOT__m_curr;
        IData/*31:0*/ top__DOT__sink__DOT____Vtogcov__m_curr;
        ...
        VlUnpacked<QData/*63:0*/, 3> top__DOT__src__DOT__m;
        VlUnpacked<QData/*63:0*/, 3> top__DOT__src__DOT____Vtogcov__m;
        VlUnpacked<IData/*31:0*/, 3> top__DOT__sink__DOT__m;
        VlUnpacked<IData/*31:0*/, 3> top__DOT__sink__DOT____Vtogcov__m;

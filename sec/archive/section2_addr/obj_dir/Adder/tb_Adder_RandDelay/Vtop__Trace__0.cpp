...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[3U])) {
        ...
        bufp->chgIData(oldp+298,(vlSelf->top__DOT__sink__DOT__msg_delay__DOT__rand_num),32);
        bufp->chgBit(oldp+299,(vlSelf->top__DOT__sink__DOT__msg_delay__DOT__rand_delay_en));
        bufp->chgIData(oldp+300,(vlSelf->top__DOT__sink__DOT__msg_delay__DOT__rand_delay_next),32);
        bufp->chgIData(oldp+301,(vlSelf->top__DOT__sink__DOT__msg_delay__DOT__rand_delay),32);
        bufp->chgBit(oldp+302,(vlSelf->top__DOT__sink__DOT__msg_delay__DOT__zero_cycle_delay));
        bufp->chgBit(oldp+303,(vlSelf->top__DOT__sink__DOT__msg_delay__DOT__state_next));
        bufp->chgBit(oldp+304,(vlSelf->top__DOT__sink__DOT__msg_delay__DOT__state));
        bufp->chgBit(oldp+305,(vlSelf->top__DOT__sink__DOT__sink__DOT__index_en));
        bufp->chgCData(oldp+306,((3U & ((IData)(1U) 
                                        + (IData)(vlSelf->top__DOT__sink__DOT__sink__DOT__index)))),2);
        bufp->chgCData(oldp+307,(vlSelf->top__DOT__sink__DOT__sink__DOT__index),2);
        bufp->chgBit(oldp+308,(vlSelf->top__DOT__sink__DOT__sink__DOT__reset_reg));
        bufp->chgBit(oldp+309,(vlSelf->top__DOT__sink__DOT__sink__DOT__done_next));
        bufp->chgBit(oldp+310,(vlSelf->top__DOT__sink__DOT__sink__DOT__failed));
        bufp->chgBit(oldp+311,(vlSelf->top__DOT__src__DOT__src_val));
        bufp->chgBit(oldp+312,(vlSelf->top__DOT__src__DOT__src_rdy));
        bufp->chgIData(oldp+313,(vlSelf->top__DOT__src__DOT__msg_delay__DOT__rand_num),32);
        bufp->chgBit(oldp+314,(vlSelf->top__DOT__src__DOT__msg_delay__DOT__rand_delay_en));
        bufp->chgIData(oldp+315,(vlSelf->top__DOT__src__DOT__msg_delay__DOT__rand_delay_next),32);
        bufp->chgIData(oldp+316,(vlSelf->top__DOT__src__DOT__msg_delay__DOT__rand_delay),32);
        bufp->chgBit(oldp+317,(vlSelf->top__DOT__src__DOT__msg_delay__DOT__zero_cycle_delay));
        bufp->chgBit(oldp+318,(vlSelf->top__DOT__src__DOT__msg_delay__DOT__state_next));
        bufp->chgBit(oldp+319,(vlSelf->top__DOT__src__DOT__msg_delay__DOT__state));
        bufp->chgBit(oldp+320,(vlSelf->top__DOT__src__DOT__src__DOT__index_en));
        bufp->chgCData(oldp+321,((3U & ((IData)(1U) 
                                        + (IData)(vlSelf->top__DOT__src__DOT__src__DOT__index)))),2);
        bufp->chgCData(oldp+322,(vlSelf->top__DOT__src__DOT__src__DOT__index),2);
        bufp->chgBit(oldp+323,(vlSelf->top__DOT__src__DOT__src__DOT__reset_reg));
        bufp->chgBit(oldp+324,(vlSelf->top__DOT__src__DOT__src__DOT__done_next));
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[4U])) {
        bufp->chgQData(oldp+325,(vlSelf->top__DOT__istream_msg),64);
        bufp->chgIData(oldp+327,(vlSelf->top__DOT__dut__DOT__a),32);
        bufp->chgIData(oldp+328,(vlSelf->top__DOT__dut__DOT__b),32);
        bufp->chgIData(oldp+329,(vlSelf->top__DOT__sink__DOT__sink__DOT__m_curr),32);
        bufp->chgQData(oldp+330,(vlSelf->top__DOT__src__DOT__src_msg),64);
    }
    bufp->chgBit(oldp+332,(vlSelf->clk));
    bufp->chgBit(oldp+333,(vlSelf->linetrace));
    bufp->chgBit(oldp+334,(vlSelf->top__DOT__reset));
    bufp->chgIData(oldp+335,(vlSelf->top__DOT__unnamedblk2__DOT__i),32);
}

...
#endif
                VL_FATAL_MT("tb_Adder_RandDelay.v", 35, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("tb_Adder_RandDelay.v", 35, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("tb_Adder_RandDelay.v", 35, "", "NBA region did not converge.");
            }

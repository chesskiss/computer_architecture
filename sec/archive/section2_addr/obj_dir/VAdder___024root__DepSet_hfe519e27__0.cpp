...
VL_INLINE_OPT void VAdder___024root___nba_sequent__TOP__0(VAdder___024root* vlSelf) {
    ...
    // Body
    if (vlSelf->reset) {
        vlSelf->sec02_Adder__DOT__b_reg = 0U;
        vlSelf->sec02_Adder__DOT__a_reg = 0U;
        vlSelf->sec02_Adder__DOT__val_reg = 0U;
    } else if (vlSelf->sec02_Adder__DOT__istream_send) {
        vlSelf->sec02_Adder__DOT__b_reg = (IData)((vlSelf->istream_msg 
                                                   >> 0x20U));
        vlSelf->sec02_Adder__DOT__a_reg = (IData)(vlSelf->istream_msg);
        vlSelf->sec02_Adder__DOT__val_reg = 1U;
    } else if (vlSelf->sec02_Adder__DOT__ostream_send) {
        vlSelf->sec02_Adder__DOT__val_reg = 0U;
    }
...
#endif
                VL_FATAL_MT("Adder.v", 10, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("Adder.v", 10, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("Adder.v", 10, "", "NBA region did not converge.");
            }

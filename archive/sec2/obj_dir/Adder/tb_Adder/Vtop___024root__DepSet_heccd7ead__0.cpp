...
#endif
                VL_FATAL_MT("tb_Adder.v", 31, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("tb_Adder.v", 31, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("tb_Adder.v", 31, "", "NBA region did not converge.");
            }

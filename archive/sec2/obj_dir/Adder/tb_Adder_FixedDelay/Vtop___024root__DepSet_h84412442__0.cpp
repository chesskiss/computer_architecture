...
VL_INLINE_OPT VlCoroutine Vtop___024root___eval_initial__TOP__0(Vtop___024root* vlSelf) {
    ...
    VL_STOP_MT("tb_Adder_FixedDelay.v", 112, "");
    vlSelf->__Vm_traceActivity[2U] = 1U;
}
...
VL_INLINE_OPT VlCoroutine Vtop___024root___eval_initial__TOP__1(Vtop___024root* vlSelf) {
    ...
    if (VL_LIKELY(vlSelf->top__DOT__src_done)) {
        ...
        VL_WRITEF("[%0t] %%Error: tb_Adder_FixedDelay.v:194: Assertion failed in %Ntop: [ FAILED ] Our sink received more messages than our source has!\n",
                  64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
        VL_STOP_MT("tb_Adder_FixedDelay.v", 194, "");
    }
    co_await vlSelf->__VdlySched.delay(0x64ULL, nullptr, 
                                       "tb_Adder_FixedDelay.v", 
                                       199);
    VL_FINISH_MT("tb_Adder_FixedDelay.v", 200, "");
...
VL_INLINE_OPT VlCoroutine Vtop___024root___eval_initial__TOP__2(Vtop___024root* vlSelf) {
    ...
    VL_WRITEF("[%0t] %%Error: tb_Adder_FixedDelay.v:214: Assertion failed in %Ntop: TIMEOUT: Testbench didn't finish in time\n",
              64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
    VL_STOP_MT("tb_Adder_FixedDelay.v", 214, "");
    VL_FINISH_MT("tb_Adder_FixedDelay.v", 215, "");
}

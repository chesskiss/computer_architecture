...
#endif
                VL_FATAL_MT("tb_Cache.v", 26, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("tb_Cache.v", 26, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("tb_Cache.v", 26, "", "NBA region did not converge.");
            }
